...
public function insertar_eventos($eve_nombre,$eve_nombrelugar,$eve_fecha,$eve_direccion,$cat_id_tipoeve,$org_id
								   ){
	$sql="CALL evento_insert('$eve_nombre','$eve_nombrelugar','$eve_fecha','$eve_direccion',
	'$cat_id_tipoeve','$org_id');";
	return ejecutarConsultaSP($sql);
}
...
public function verificar($cli_cedula){
	...
	public function combo_organizadores(){
	$sql="CALL sp_organizadores_combo();";
	return ejecutarConsultaSP($sql);
}
