...
public function insertar_organizadores($org_nombre,$org_telefono,$org_correo,$org_direccion
								   ){
	$sql="CALL organizador_insert('$org_nombre','$org_telefono','$org_correo',
	'$org_direccion');";
	return ejecutarConsultaSP($sql);
}
