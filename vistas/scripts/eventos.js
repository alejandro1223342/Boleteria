...
//mostramos los combos
  $.post("../ajax/eventos.php?op=combo_categoria", function(r){
   	$("#categoria").html(r);
	...
	$.post("../ajax/eventos.php?op=combo_eventos", function(r){
   	$("#tipoevento").html(r);
   	$("#tipoevento").selectpicker('refresh');
     });
	
	$.post("../ajax/eventos.php?op=combo_organizadores", function(r){
   	$("#organizador").html(r);
   	$("#organizador").selectpicker('refresh');
     });
     ...
     $.ajax({
     	...
     	success: function(datos){
     		if (datos=="Datos registrados correctamente")
				...
				bootbox.alert("El evento ya existe");
//     		mostrarform(false);
     		tabla.ajax.reload();
     	}
     });
